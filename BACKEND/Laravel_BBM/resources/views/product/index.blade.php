...
<div class="container-fluid info" style="margin-top:80px;">
    <div class="d-flex justify-content-start mb-3">
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="/bibit/assets/products/{{ $bibit->foto1 }}" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="/bibit/assets/products/{{ $bibit->foto2 }}" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="/bibit/assets/products/{{ $bibit->foto3 }}" class="d-block w-100" alt="...">
                  </div>
                </div>
        ...
        <div class="container-fluid">
          <div class="title">{{ $bibit->nama }}</div>
          <div class="rp" style="margin-bottom:10px; margin-left: 30px;">Rp.{{ $bibit->harga }}</div>
          <div class="rating">{!! $bibit->rating !!}</div>
          <div class="gaya">Isi: {{ $bibit->isi }}</div>
          <div class="gaya">Keterangan: {{ $bibit->keterangan }}</div>
          <div class="stock">Stok: {{ $bibit->stok }}</div>
