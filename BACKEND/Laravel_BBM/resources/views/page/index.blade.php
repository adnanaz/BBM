...
@foreach ($diskon as $dis)
  ...
  <div class="item">
    <div class="pad15" style="background-color: #ffff;">                 
      <a href="/diskon/{{$dis->id}}">
      <figure class="produk">
      <div class="cover">
        <img src="/bibit/assets/products/{{ $dis->foto1 }}"/>
      </div>
...
@endforeach
  ...
  <div class="container-fluid mt-2" style="padding-left: 2px;padding-right: 2px;margin-left: 7px;margin-right: auto;">
    ...
    <a href="/produk/{{$bibit->id}}">
    <article class="product" data-product-id="{{$bibit -> id}}">
      <div class="product-wrapper">
        <div class="product-img">
          <img src="/bibit/assets/products/{{ $bibit->foto1 }}"/>
        </div>
      </a>
        <div class="product-info">
          ...
          <p>{!! $bibit->rating !!}</p>
          <div class="d-flex justify-content-start mb-3"> 
          <div class="rp">Rp.</div><span class="product-price">{{ $bibit->harga }}</span>
